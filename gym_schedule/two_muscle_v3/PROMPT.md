...
* Monday: Chest (Major), Back (Minor), Include HIIT Treadmill post workout (Mention minutes based on muscle group that it should not loose pump)
* Tuesday: Shoulder (Major), Biceps (Minor), Include HIIT Treadmill post workout (Mention minutes based on muscle group that it should not loose pump)
* Wednesday: Thigh (Major), Triceps (Minor) 
* Thursday: Back (Major), Chest (Minor), Include HIIT Treadmill post workout (Mention minutes based on muscle group that it should not loose pump)
* Friday: Biceps (Major), Shoulder (Major), Include HIIT Treadmill post workout (Mention minutes based on muscle group that it should not loose pump)
* Saturday: Triceps (Major), Thigh (Minor) 
...
* **Replace Pull-Ups, Bulgarian Split Squats, and Sumo Deadlifts with machine-based alternatives**
...
7. The plan should be tailored to the January–March cutting phase with consideration for hot weather, supporting low calorie intake, endurance progression, and recovery.
8. **Present the entire plan in comprehensive tabular format including:**
   - All 6 workout days with exercise tables
   - Progressive overload timeline
   - Nutritional framework
   - Heat adaptation strategy
   - Recovery & supplement protocol
   - HIIT cardio specifications
...
* Lats (Latissimus Dorsi): Lat Pulldown (Wide or Close Grip), Bent-Over Barbell Rows, T-Bar Row, Behind-the-Neck Lat Pulldown
...
* Teres Major: One-Arm Lat Pulldown, Chest-Supported Machine Row (Neutral or Underhand Grip)

### **Legs**

* Quadriceps: Barbell Back Squat, Leg Press (Feet Low & Close Stance)
* Adductors: Leg Press (Wide Stance), Jefferson Squats (Barbell or Dumbbells), Lateral Lunges (Dumbbell or Bodyweight)
...
* Glutes: Barbell Hip Thrusts, Cable Kickbacks (Glute Focus), Leg Press (Single-Leg or High/Wide Stance)
